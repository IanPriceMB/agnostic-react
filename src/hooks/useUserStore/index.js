...
/**
 * This hook is made from the makeStore utility function. It returns a <context.Provider> in the shape of a React.useReducer
 * this means that this hook is essentially ONE Redux reducer in mini form that we can use where ever we want in our App!
 * This particular Provider is wrapping the whole applicaiton meaning we can dispatch and recieve user data at/from any location.
 * 
 * I took the liberty of extending the pattern even further by taking the dispatch function that is return from the makeStore utility, 
